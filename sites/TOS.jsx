        ...
        <div className="row">
          <div className="TOS-wrapper">
            <p className="TOS_text">
              1. OUR SERVICES The information provided when using the Services
            ...
            <p className="TOS_text">
              2. INTELLECTUAL PROPERTY RIGHTS Our intellectual property We are
              the owner or the licensee of all intellectual property rights in
              ...
              around the world. The Content and Marks are provided in or through
              the Services "AS IS" for your personal, non-commercial use or
              internal business purpose only.Your submissions Please review this
            ...
            <p className="TOS_text">
              ...
              warrant that: (1) you have the legal capacity and you agree to
              comply with these Legal Terms; (2) you are not a minor in the
              ...
              bot, script or otherwise; (4) you will not use the Services for
              any illegal or unauthorized purpose; and (5) your use of the
              Services will not violate any applicable law or regulation. If you
            ...
            <p className="TOS_text">
              4. PROHIBITED ACTIVITIES You may not access or use the Services
              ...
              from us. Trick, defraud, or mislead us and other users, especially
              ...
              opinion, us and/or the Services. Use any information obtained from
              the Services in order to harass, abuse, or harm another person.
              Make improper use of our support services or submit false reports
              of abuse or misconduct. Use the Services in a manner inconsistent
              with any applicable laws or regulations. Engage in unauthorized
              framing of or linking to the Services. Upload or transmit (or
            ...
            <p className="TOS_text">
              5. USER GENERATED CONTRIBUTIONS The Services does not offer users
              to submit or post content. We may provide you with the opportunity
            ...
            <p className="TOS_text">
              6. CONTRIBUTION LICENSE You and Services agree that we may access,
              store, process, and use any information and personal data that you
              provide and your choices (including settings). By submitting
            ...
            <p className="TOS_text">
              7. SERVICES MANAGEMENT We reserve the right, but not the
            ...
            <p className="TOS_text">
              8. TERM AND TERMINATION These Legal Terms shall remain in full
              force and effect while you use the Services. WITHOUT LIMITING ANY
              OTHER PROVISION OF THESE LEGAL TERMS, WE RESERVE THE RIGHT TO, IN
            ...
            <p className="TOS_text">
              9. MODIFICATIONS AND INTERRUPTIONS We reserve the right to change,
              modify, or remove the contents of the Services at any time or for
              any reason at our sole discretion without notice. However, we have
              ...
              price change, suspension, or discontinuance of the Services. We
            ...
            <p className="TOS_text">
              10. GOVERNING LAW These Legal Terms and your use of the Services
              are governed by and construed in accordance with the laws of the
              State of Michigan applicable to agreements made and to be entirely
              performed within the State of Michigan, without regard to its
              conflict of law principles.
            </p>
            <p className="TOS_text">
              11. DISPUTE RESOLUTION Informal Negotiations To expedite
              ...
              other Party. Binding Arbitration Any dispute arising out of or in
              ...
              which, as a result of referring to it, is considered as the part
              of this clause. The number of arbitrators shall be __________. The
              ...
              Restrictions The Parties agree that any arbitration shall be
              ...
              piracy, invasion of privacy, or unauthorized use; and (c) any
            ...
            <p className="TOS_text">
              12. CORRECTIONS There may be information on the Services that
            ...
            <p className="TOS_text">
              13. DISCLAIMER THE SERVICES ARE PROVIDED ON AN AS-IS AND
              AS-AVAILABLE BASIS. YOU AGREE THAT YOUR USE OF THE SERVICES WILL
            ...
            <p className="TOS_text">
              14. LIMITATIONS OF LIABILITY IN NO EVENT WILL WE OR OUR DIRECTORS,
            ...
            <p className="TOS_text">
              15. INDEMNIFICATION You agree to defend, indemnify, and hold us
              ...
              due to or arising out of: (1) use of the Services; (2) breach of
            ...
            <p className="TOS_text">
              16. USER DATA We will maintain certain data that you transmit to
            ...
            <p className="TOS_text">
              19. MISCELLANEOUS These Legal Terms and any policies or operating
